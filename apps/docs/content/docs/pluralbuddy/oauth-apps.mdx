...
The OpenID Configuration for PluralBuddy is located [here](/.well-known/openid-configuration). (`https://pluralbuddy.app/.well-known/openid-configuration`)
...
```
https://pluralbuddy.app/api/auth/oauth2/authorize
    ?client_id=123456789
    &response_type=code
    &redirect_uri=https://example.com
    &scope=profile openid offline_access alters:read system:read
    &code_challenge=xxx
...
| `application/x-www-form-urlencoded`      | Description                                                     | Required                         |
|------------------------------------------|-----------------------------------------------------------------|----------------------------------|
...
| `resource`                               | Always `https://pluralbuddy.app`.                               | `true`                           |
