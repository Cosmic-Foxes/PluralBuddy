								...
								<Accordion type="single" className="mt-2 rounded-lg border">
									...
									>
										...
										<AccordionContent className="h-full">
											thank you so much. you know who you all are. i wouldn't be
											alive to this day if it wasn't for all of you. every
											...
											there at my lowest when i really, <i>really</i> needed it.
										</AccordionContent>
									</AccordionItem>
									<AccordionItem
										value="k"
									...
									>
										...
										<AccordionContent className="h-full">
											thank you for being the best friend ever. even if you are
											gone now, i will miss you deeply for every day you are
											gone. i hope you're okay 💗
										</AccordionContent>
									</AccordionItem>
								</Accordion>
							</CardContent>
