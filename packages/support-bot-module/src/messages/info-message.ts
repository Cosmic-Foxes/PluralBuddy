...
> 2. **No NSFW content**, as per PluralBuddy's [Terms of Service](https://pluralbuddy.app/docs/policies/terms)
...
> 6. **Use your head.** These rules aren't perfect. If you think something might not be allowed, don't do it.`),
                new ActionRow()
                    .setComponents(
                        new Button()
                            .setURL("https://pluralbuddy.app/docs/policies/terms")
                            .setStyle(ButtonStyle.Link)
                            .setLabel("PluralBuddy ToS"),
                        new Button()
                            .setURL("https://pluralbuddy.app/docs/policies/privacy")
                            .setStyle(ButtonStyle.Link)
