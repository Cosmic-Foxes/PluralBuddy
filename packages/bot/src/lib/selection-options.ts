...
export const tagPrivacySelection = (
	translations: TranslationString,
	existing?: number,
) => [
	new StringSelectOption()
...
export const alterPrivacySelection = (
	translations: TranslationString,
	existing?: number,
) => [
	new StringSelectOption()
...
export const tagColorSelection = (
	translations: TranslationString,
	existing?: string,
) => [
	...tagColors.map((color) =>
		new StringSelectOption()
			...
			.setValue(
				InteractionIdentifier.Selection.TagColors[
					color as keyof typeof InteractionIdentifier.Selection.TagColors
				].create(),
			)
