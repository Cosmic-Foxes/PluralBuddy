...
-# Hvis du vil importere fra Tupperbox, på grunn av manglende data som Tupperbox eksport data gir, du må opprette systemet og deretter kjøre \`{{ prefix }}systemet importen \`.`,
	...
	NO_SERVER_DELETION:
		"PluralBuddy Uttryk altere må være lagt til i en server for at meldingene skal være kvalifisert for å bli slettet pga Discord restriksjoner. Men du burde ha muligheten til å høyreklikke slett det selv!",
	BLOCKED:
		"Du har blitt blokkert fra **{{ guild }}**. Du kan ikke bruke PluralBuddy i denne serveren.",
...
> -# {{ reply }} Please view the DM from <@1455014942888693792> regarding case \`{{ libbyCaseId }}\`.`,
	...
	ERROR_DISABLED_SYSTEM:
		"2f - Systemet ditt er deaktivert. Du kan ikke proxye det.",
	OPTION_DISABLED:
		"Dette alternativet kan ikke bli valgt. Dette alternativet er deaktivert.",
	TOO_MANY_BLOCKED_ITEMS:
		"Det er for mange blokkerte elementer. Du kan bare ha 25 blokkerte roller, og 25 blokkerte kanaler på en gang pga Discord sine modal-restriksjoner.",
	TOO_MANY_MANAGER_ITEMS:
		"Det er for mange lederolle elementer. Du kan bare ha 25 lederroller på en gang pga Discord sine modal-restriksjoner.",
