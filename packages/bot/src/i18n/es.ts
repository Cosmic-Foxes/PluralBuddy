...
SimplyPlural ha sido descontinuado.`,
	...
	ERROR_ATTACHMENT_TOO_LARGE:
		"2j – Los archivos adjuntos para banners o imágenes de perfil no pueden superar los 2MB.",
...
> -# [Términos de servicio](<https://pb.giftedly.dev/docs/policies/terms>) · [Política de privacidad](<https://pb.giftedly.dev/docs/policies/privacy>)`,
 ...
 > %description%`,
	...
	SUCCESSFULLY_EDITED_MESSAGE:
		"Se editó con éxito [ese mensaje](<%message%>).",
...
%manager_roles%`,
	...
	MANAGER_ALREADY_EXISTS:
		"Ese rol de administrador ya está en la lista.",
