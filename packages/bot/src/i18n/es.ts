...
-# Para importar desde Tupperbox, debido a la falta de datos que proporciona su exportación, debes crear el sistema y luego ejecutar \`{{ prefix }}system import\`.`,
	...
	NO_SERVER_DELETION:
		"Los alters de PluralBuddy Express deben ser invitados realmente a un servidor para que los mensajes puedan ser eliminados debido a restricciones de Discord. ¡Sin embargo, deberías poder eliminarlo tú mismo haciendo clic derecho!",
	BLOCKED:
		"Has sido bloqueado/a de **{{ guild }}**. No puedes usar PluralBuddy en este servidor.",
...
> -# {{ reply }} Please view the DM from <@1455014942888693792> regarding case \`{{ libbyCaseId }}\`.`,
	...
	ERROR_DISABLED_SYSTEM:
		"2f – Tu sistema está desactivado. No puedes usar proxy.",
	OPTION_DISABLED: "Esta opción no se puede seleccionar. Está desactivada.",
	TOO_MANY_BLOCKED_ITEMS:
		"Hay demasiados elementos bloqueados. Solo puedes tener 25 roles bloqueados y 25 canales bloqueados a la vez debido a limitaciones de los modales de Discord.",
	TOO_MANY_MANAGER_ITEMS:
		"Hay demasiados elementos de administrador. Solo puedes tener 25 roles de administrador a la vez debido a limitaciones de los modales de Discord.",
...
Los sistemas pueden tener **valores de privacidad**, que son ajustes que describen quién puede ver cada parte de tu sistema. Por defecto, tu sistema es completamente privado, salvo la automoderación del servidor y los mensajes que envía tu sistema. Sin embargo, cambiarlos modificará dichos valores.`,
	...
	CREATING_NEW_SYSTEM_PRIVACY_FORM_DESC:
		"Selecciona los valores de privacidad que deseas que sean públicos.",
...
> - Para crear una nueva etiqueta, intenta usar %command2%`,
	SETUP_ERROR_SYSTEM_ALREADY_EXISTS:
		"2b – No puedes configurar un nuevo sistema si ya existe un sistema vinculado a tu cuenta.",
	SETUP_ERROR_SYSTEM_ALREADY_EXISTS_BTN:
		"Eliminar sistema y configurar de nuevo",
	ERROR_PAGINATION_TOO_OLD:
		'2g – Ese componente de paginación de alters es demasiado antiguo, no puedes continuar. Por favor, haz clic en la pestaña "Alters" en la parte superior del mensaje para reiniciar la paginación.',
	ERROR_TAG_PAGINATION_TOO_OLD:
		'2h – Ese componente de paginación de etiquetas es demasiado antiguo, no puedes continuar. Por favor, haz clic en la pestaña "Etiquetas" en la parte superior del mensaje para reiniciar la paginación.',
	ERROR_ASSIGN_PAGINATION_TOO_OLD:
		"2i – Ese componente de paginación es demasiado antiguo, no puedes continuar. Por favor, vuelve atrás y haz clic en el botón Asignar de nuevo para que vuelva a funcionar.",
...
SimplyPlural ha sido descontinuado.`,
	PAGE_NEW_SYS_TEXT:
		"-# Página 3/3 · Algunos campos no se han completado. · * Obligatorio",
	...
	PLURALBUDDY_IMPORT_ERROR_TOO_LARGE:
		"2j – Los archivos a importar no pueden superar los 2MB. Por favor, contacta con soporte si realmente estás intentando importar un sistema superior a 2MB.",
	ERROR_ATTACHMENT_TOO_LARGE:
		"2j – Los archivos adjuntos para banners o imágenes de perfil no pueden superar los 1MB.",
	...
	PLURALBUDDY_IMPORT_ERROR_INVALID_JSON:
		"2k – El archivo que importaste no es un JSON válido.",
	ERROR_INTERACTION_TOO_OLD:
		"2l – Ya no se realiza el seguimiento de esta interacción. (¿has esperado demasiado?)",
	ERROR_SYSTEM_DOESNT_EXIST:
		"2m – No se puede concluir esta operación porque no existe ningún sistema sobre el que operar.",
	ERROR_ALTER_DOESNT_EXIST:
		"2n – No se puede concluir esta operación porque no existe el alter o no hay ningún sistema asociado al usuario que realizó la solicitud.",
	ERROR_ALTER_DOESNT_EXIST_SUGGESTION:
		"2n – No se pudo encontrar ese alter. ¿Quisiste decir `%suggestion%`?",
	ERROR_TAG_DOESNT_EXIST:
		"2o – No se puede concluir esta operación porque no existe la etiqueta o no hay ningún sistema asociado al usuario que realizó la solicitud.",
	...
	ALTER_SUCCESS_PRONOUNS:
		"Se han establecido con éxito los pronombres de @%alter% a %new%.",
	ALTER_SUCCESS_PRIVACY:
		"Se han establecido con éxito los valores de privacidad pública de @%alter% a %new% (%number% valores en total).",
	ALTER_SUCCESS_DESC: "Se ha establecido con éxito la descripción de @%alter%.",
	TAG_SUCCESS_ORDER:
		"Se ha establecido correctamente la cadena de orden para @%tag%.",
	PAGINATION_TITLE: "Página",
	WAITING: "Cargando...",
	WAITING_LONG_TERM: "Cargando... Esto tomará un momento. Por favor, espera.",
	SUCCESSFULLY_IMPORTED:
		"Se han importado con éxito %alter_count% alter(s) para %system_name%.",
...
> - Opcionalmente, puedes mostrar estas etiquetas activando la opción "Mostrar etiquetas proxy" del sistema en la segunda página.`,
	...
	CREATING_NEW_PT_ERROR:
		"2p – El formato no es correcto. Recuerda que debes tener un prefijo y un sufijo separados por `texto`.",
	CREATING_NEW_PT_TOO_MANY_CHARS:
		"2y – Hay demasiados caracteres en el prefijo o en el sufijo. Recuerda que solo puedes tener hasta 20 caracteres para el prefijo y 20 para el sufijo.",
	SUCCESSFULLY_NEW_PT: "¡Se ha creado con éxito una nueva etiqueta proxy!",
	PLURALBUDDY_IMPORT_DESC:
		"Copia y pega los datos JSON exportados a continuación:",
	...
	CREATE_NEW_ALTER_ADD:
		"Se realizaron las siguientes operaciones adicionales en este alter:",
	...
	NO_SUCH_TAG_CANT_ASSIGN:
		"No se puede asignar este alter a la etiqueta especificada porque no existe.",
	CREATE_NEW_ALTER_DISPLAY_NAME: "Nombre para mostrar asignado: **{{ dn }}**",
	CREATE_NEW_TAG_DONE:
		"Se ha creado con éxito %color_emoji% **%tag_name%** en tu sistema. Usa %command% para más detalles.",
	TAG_SPACE_WARNING:
		"Dado que esta etiqueta contiene **espacios**, algunos comandos pueden requerir que entrecomilles el nombre para mostrar. También puedes usar directamente los comandos de aplicación.",
	TAG_ALREADY_EXISTS:
	...
	CONFIRMATION_SYSTEM_DELETION_BTN:
		"Entiendo que esta es una acción permanente, continuar",
	...
	SYSTEM_DELETION_DM:
		"Aquí tienes los datos de exportación debido a la eliminación del %time%:",
	...
	SYSTEM_EXPORT_FINISHED:
		"Se ha exportado tu sistema con éxito. Debería estar visible en el mensaje a continuación.",
	...
	INVISIBLE_ALTER:
		"No puedes ver este alter debido a su configuración de privacidad.",
	INVISIBLE_TAG:
		"No puedes ver esta etiqueta debido a su configuración de privacidad.",
	...
	SYSTEM_NICKNAME_FORM_DESC:
		'Donde "%username%" es el nombre de usuario de tu alter, y "%display%" es el nombre para mostrar de tu alter',
...
-# Tu nombre en %server% es: %name%`,
	ALTER_SET_USERNAME_DESC:
		"Los nombres de usuario de los alters no pueden contener espacios y deben tener menos de 20 caracteres. Se utilizan para identificar a tu sistema en los comandos.",
	ALTER_SET_USERNAME_SPACES:
		"No se permiten espacios, `@`, `` ni `/` en los nombres de usuario.",
...
-# Desplázate hacia abajo para ver el resto de este modal.`,
	...
	ALTER_SET_PFP_SE_DESC:
		"Esta foto de perfil solo se utilizará específicamente en este servidor.",
	ALTER_SET_TAG: "Establecer etiqueta del sistema",
	ALTER_SET_BANNER: "Establecer banner",
	INVALID_URL:
		"Esta no es una URL válida. Asegúrate de no envolver tu URL entre `<` o `>`",
	ALTER_SET_PRIVACY: "Establecer privacidad",
	ERROR_INVALID_ATTACHMENT_TYPE:
		"2s – El archivo adjunto que subiste no es una imagen.",
	ERROR_INVALID_COLOR:
		"2t – El color ingresado no es un código hexadecimal válido.",
	...
	TAG_SET_COLOR_DESC:
		"Hay 17 colores diferentes que puedes elegir para tu etiqueta, cada uno con un icono de color único para distinguirlos.",
	TAG_SET_PRIVACY_DESC:
		"Por defecto, todos los valores de las etiquetas son privados. Usa el botón para configurar los valores públicos.",
	...
	TOO_MANY_TAGS:
		"Hay demasiadas etiquetas en tu sistema de PluralBuddy (500 etiquetas). Por favor, contacta con soporte si crees que esto es un error.",
	...
	DISABLED_SYSTEM:
		"Se ha desactivado tu sistema con éxito. **No** podrás usar proxy ya que todo tu sistema ha sido **desactivado**.",
	ENABLED_SYSTEM:
		"Se ha activado tu sistema con éxito. Podrás usar proxy ya que todo tu sistema ha sido **activado**.",
...
(con \`-public\` al final) Configurar estos valores le indica a PluralBuddy qué mostrar a otras personas.`,
	...
	SYSTEM_ADVANCED_IMPORT:
		"Se realizó con éxito una operación de importación avanzada. **{{ alter-count }}** alter(s) y **{{ tag-count }}** etiqueta(s) fueron afectados en esta importación.",
	ALTER_DELETE_DESC:
		"Eliminar un alter lo removerá por completo del sistema sin opción de deshacer.",
	MONGO_REGEX_ERROR:
		"Esta no es una expresión regular válida. Si estás usando ( o ) o *, intenta agregar dos barras invertidas al principio.",
	...
	DN_SUCCESS:
		"Se actualizó con éxito el nombre para mostrar de @%alter% a %new-display%.",
	DN_SUCCESS_SS:
		"Se actualizó con éxito el nombre para mostrar de @%alter% a %new-display% **en %server%**.",
	COLOR_SUCCESS: "Se actualizó con éxito el color de @%alter%.",
	ERROR_MANUAL_PROXY:
		"2u – Ocurrió un error al enviar el proxy manualmente. Por favor, inténtalo de nuevo más tarde.",
	SUCCESS_PROXY: "¡[Tu mensaje](<%message-link%>) ha sido enviado!",
	CONTENT_ERROR_PROXY:
		"2v – Debes incluir texto o un archivo adjunto para enviar un proxy.",
	ERROR_USER_BLOCKED:
		"2a – Este usuario tiene bloqueado el uso de PluralBuddy.",
	...
	SERVER_TOO_BIG:
		"Este servidor es demasiado grande para usar el comando /proxy, ya que está desactivado por motivos de seguridad en servidores con más de 30 miembros. Por favor, usa el proxy automático en su lugar.",
	OPERATION_DISCORD_AP:
		"Cambiado en %server_name% (`%server_id%`) • %discord% Discord",
	CLEARED_LATCH:
		"Se ha limpiado con éxito el **alter fijado** en %server_name%.",
	NO_PERMISSIONS_PROXY:
		"No puedo enviar mensajes proxy aquí porque no tengo los permisos `Gestionar Webhooks` y `Gestionar Mensajes` en este canal.",
	NICKNAME_MANUAL_PROXY:
		"No puedes enviar proxy aquí porque el alter especificado utiliza el modo proxy Apodo, y no puedes enviar un mensaje normal al usar el comando de proxy manual. Por favor, usa el proxy automático.",
	...
	OPERATION_CHANGE_SE_TAG:
		"Etiqueta específica del servidor en %server% cambiada a `%tag%`.",
	OPERATION_CHANGE_DISABLED: "Sistema desactivado",
	OPERATION_CHANGE_ENABLED: "Sistema activado",
	OPERATION_CHANGE_PRIVACY:
		"Valores de privacidad del sistema establecidos en %privacy%.",
	OPERATION_UNDO_SUCCESS:
		"Se actualizaron con éxito %value-count% valor(es) como resultado de deshacer la acción.",
	NEW_ROLE_PREF: "Creando preferencia de rol...",
	ROLE_USAGE: "Rol",
	UNABLE_TO_BE_FUNNY: "No tienes permitido usar los comandos divertidos.",
	DISABLED_DM_REPLIES:
		"Se han desactivado las respuestas por DM. Usa `pb;nudge-preferences` para volver a activarlas.",
...
-# (๑˃ᴗ˂)ﻭ Hecho con **amor.**`,
	...
	POLICY_MODAL_DETAIL:
		"Acepto la Política de privacidad y los Términos de servicio de PluralBuddy.",
	POLICY_MODAL_BLOCK_DETAIL:
		"Entiendo que puedo ser bloqueado/a si rompo estas reglas.",
	POLICY_MODAL_BLOCK_DESC:
		"Tienes 30 días para apelar un bloqueo antes de que se eliminen todos tus datos - los datos en infracción se eliminan al instante",
	...
	ALTER_DESC:
		"Usar solo este alter hasta que se desactive el proxy automático.",
	ALTER_DESC_DISABLED:
		"Esta opción no se puede seleccionar. Debes ingresar a un alter para seleccionarla.",
	OFF_NAME: "Desactivado",
	OFF_DESC: "Desactivar el proxy automático en tu sistema.",
	DELETE_DESC:
		"**Esto no se puede deshacer.** Eliminar un alter borrará al alter y todos sus datos.",
	PROXY_MODE_TITLE:
		"### {{ circleQuestion }} Modo Proxy · @{{ alterUsername }}",
...
-# Nombre para mostrar: {{ currentDisplayName }}`,
	PUBLIC_PROFILE_PFP_DESC:
		"Puedes establecer una **foto de perfil** subiendo una imagen desde el panel de la derecha.",
	PUBLIC_PROFILE_BANNER_DESC:
		"Puedes establecer un **banner** subiendo una imagen desde el panel de la derecha.",
...
-# Para ver tu descripción completa, ejecuta: {{ mention }}`,
	PUBLIC_PROFILE_COLOR_DESC:
		"Establecer un color para un alter muestra ese color en su contenedor de rango y en su perfil público.",
...
{{ roleList }}`,
	...
	NUDGING_DESC:
		"Los toques permiten a otros usuarios mencionarte o darte un toque según tu alter. Puedes cambiar esta opción en cualquier momento. Desactivarla no te quita la capacidad de dar toques a otros, solo evita que otros te los den a ti.",
	DM_REPLIES_DESC:
		"Las respuestas por DM te enviarán un mensaje privado cuando alguien te responda. **Debes tener los DMs activados en al menos uno de los servidores en los que estoy o no podré contactarte.**",
...
> El retraso actual en este servidor es de **{{ delay }} segundos** ({{ delayMs }}ms)`,
	...
	NO_ERRORS:
		"{{ catJamming }} ¡Genial! ¡Tu servidor no ha registrado ningún error!",
...
A continuación hay un ejemplo de cómo se vería un mensaje proxy con este rol:`,
	CONTENTS_EMPTY:
		"-# No hay contenedor para este rol ya que el contenido está vacío.",
	...
	SYSTEM_NAME_DESC:
		"El título de tu sistema es lo primero que lo identifica y aparece en la estructura superior para todos los miembros. Debe tener entre 3 y 20 caracteres de longitud.",
	SYSTEM_NICKNAME_FORMAT_BTN: "Establecer formato de apodo",
	SYSTEM_NICKNAME_FORMAT_DESC:
		"El formato de apodo define cómo se muestra tu nombre cuando un alter usa el modo proxy *Apodo*. Por defecto es solo el nombre de usuario del alter, pero puedes personalizarlo.",
...
> - *Desactivado*: Usar etiquetas proxy enviará un mensaje proxy, de lo contrario se enviará un mensaje normal.`,
	...
	EXPORT_SYS_DESC:
		"Exportar el sistema simplemente extraerá todos los datos y los enviará a tus mensajes directos (DMs). Asegúrate de tener los DMs abiertos para PluralBuddy antes de exportar.",
	EXTERNAL_EXPORT_SYS_DESC:
		"Puedes exportar externamente a otro servicio haciendo clic en la opción deseada a continuación:",
	IMPORT_SYS_BTN: "Importar sistema",
	IMPORT_SYS_DESC:
		"Importar tu sistema te permite traer datos desde otros bots mediante diferentes modos de importación.",
	DANGER_ZONE_TITLE: "## Zona de peligro",
	SYSTEM_E: "Activar sistema",
	SYSTEM_D: "Desactivar sistema",
	SYSTEM_D_DESC:
		"Desactivar un sistema desactivará la **capacidad de usar proxy** en todos los servidores y se puede deshacer más adelante. **Todos tus alters, etiquetas y recursos seguirán accesibles, pero __NO PODRÁS enviar mensajes proxy__**.",
	DELETE_SYS_BTN: "Eliminar sistema",
	DELETE_SYS_DESC:
		"**Esto no se puede deshacer**. Eliminar tu sistema **borrará los datos del sistema __junto con todos los alters, etiquetas y demás recursos__**. **__USA ESTO CON PRECAUCIÓN__**.",
	ALTERS_TITLE: "## Alters",
...
Tu perfil público es cómo se ve tu sistema para otros usuarios cuando identifican tus mensajes.`,
	...
	SELF_REACTION_DESC:
		"PluralBuddy no pudo remover el emoji de carga al intentar realizar una [Acción del menú contextual](<https://pb.giftedly.dev/docs/pluralbuddy/context-actions>).",
	...
	NOTIFIED_2:
		"-# Desarrollado como software de código abierto en [pb.giftedly.dev](<https://pb.giftedly.dev>)",
...
\`pb;autoproxy [off|latch|alter|status|{{ aiap }}]\``,
	...
	TOGGLED_INCLUDING_PROXY_TAGS_E:
		"Se cambió la opción de incluir etiquetas proxy. (activado)",
	TOGGLED_INCLUDING_PROXY_TAGS_D:
		"Se cambió la opción de incluir etiquetas proxy. (desactivado)",
	TOGGLED_INCLUDING_PRONOUNS_E:
		"Se cambió la opción de incluir pronombres. (activado)",
	TOGGLED_INCLUDING_PRONOUNS_D:
		"Se cambió la opción de incluir pronombres. (desactivado)",
	NOT_FRIDAY:
		"Flatworm Friday solo se celebra los viernes en Nueva York, vuelve el próximo viernes a Wall Street o usa `--time-machine`.",
	EXPRESS_DISCONTINUED:
		"Lo sentimos, PluralBuddy Express ha sido interrumpido desde el 08/11/26. ¡Utiliza una alternativa como [/plu/ral](https://plural.gg) en su lugar! ¡Las aplicaciones exprés seguirán enviando mensajes!",
	NO_TYPING_STATUS:
		"Deshabilitar el estado de escritura eliminará el estado de escritura que aparece cuando este proxy del sistema. Los estados de escritura todavía no aparecen si el servidor lo desactiva.",
	...
	TOGGLED_TYPING_STATUS_E:
		"Se ha cambiado correctamente el estado de escritura. (activado)",
	TOGGLED_TYPING_STATUS_D:
		"Se ha cambiado correctamente el estado de escritura. (desactivado)",
};
