...
-# Um von Tupperbox zu importieren, da die Daten von Tupperbox nicht vorhanden sind, du musst das System erstellen und dann \`{{ prefix }}system import\` ausführen.`,
	...
	NO_SERVER_DELETION:
		"PluralBuddy Express Änderungen müssen tatsächlich auf einen Server eingeladen werden, damit Nachrichten aufgrund von Discord-Einschränkungen gelöscht werden können. Du solltest jedoch in der Lage sein ihn mit der rechten Maustaste zu löschen!",
	BLOCKED:
		"Du wurdest von {{ guild }} gesperrt. Die Nutzung von PluralBuddy ist in dieser Gilde nicht mehr möglich.",
...
> -# {{ reply }} Bitte beachte die Direktnachricht von <@1455014942888693792> bezüglich des Falls \`{{ libbyCaseId }} \`.`,
	...
	ERROR_DISABLED_SYSTEM:
		"2f – Ihr System ist deaktiviert. Sie können keinen Proxy verwenden.",
	OPTION_DISABLED:
		"Diese Option kann nicht gewählt werden. Diese Option ist deaktiviert.",
	TOO_MANY_BLOCKED_ITEMS:
		"Es gibt zu viele blocks Artikel. Du kannst nur 25 blocks Rollen und 25 blocks Kanäle gleichzeitig haben, aufgrund von Discord modale Einschränkungen.",
	TOO_MANY_MANAGER_ITEMS:
		"Es gibt zu viele Manager Artikel. Aufgrund von Beschränkungen des Discord modal können Sie maximal 25 Manager Artikel gleichzeitig haben.",
...
Systeme können **Privatsphäre Werte** haben, welche Werte beschreiben, wer welchen Teil Ihres Systems sehen kann. Standardmäßig ist Ihr System neben der automatischen Moderation des Servers und der Meldung, die Ihr System sendet, komplett privat.`,
	...
	CREATING_NEW_SYSTEM_PRIVACY_FORM_DESC:
		"Wählen Sie die Datenschutzeinstellungen aus, die öffentlich zugänglich sein sollen.",
...
> - Um ein neues Tag zu erstellen, versuchen Sie es mit %command2%`,
	SETUP_ERROR_SYSTEM_ALREADY_EXISTS:
		"2b – Sie können kein neues System einrichten, wenn ein System unter Ihrem Konto bereits existiert.",
	SETUP_ERROR_SYSTEM_ALREADY_EXISTS_BTN: "System & Setup erneut entfernen",
	ERROR_PAGINATION_TOO_OLD:
		'2g – Die Alter Paginierungs Komponente ist veraltet. Sie können nicht fortfahren. Klicken Sie bitte oben in der Meldung auf den Tab "Alter", um die Seiteneinstellungen zurückzusetzen.',
	ERROR_TAG_PAGINATION_TOO_OLD:
		'2h – Diese Tag Pagination Komponente ist zu alt, Sie können nicht fortfahren. Bitte klicken Sie auf die Registerkarte "Tags" oben in der Nachricht, um die Pagination zurückzusetzen.',
	ERROR_ASSIGN_PAGINATION_TOO_OLD:
		"2i – Diese Paginations komponente ist zu alt, Sie können nicht fortfahren. Bitte gehen Sie zurück und klicken Sie erneut auf den Knopf Zuordnen, damit die Paginations komponente wieder funktioniert.",
...
SimplyPlural has been discontinued.`,
	PAGE_NEW_SYS_TEXT:
		"-# Seite 3/3 · Einige Felder bleiben leer. · * erforderlich",
	...
	PLURALBUDDY_IMPORT_ERROR_TOO_LARGE:
		"2j – Die zu importierenden Daten dürfen 2 MB nicht überschreiten. Bitte kontaktieren Sie den Support, wenn Sie versuchen, Dateien zu importieren, die größer als 2 MB sind.",
	ERROR_ATTACHMENT_TOO_LARGE:
		"2j – Anhänge für Banner oder Profilbilder dürfen 2 MB nicht überschreiten.",
	...
	PLURALBUDDY_IMPORT_ERROR_INVALID_JSON:
		"2k – Die importierte Datei ist kein gültiges JSON.",
	ERROR_INTERACTION_TOO_OLD:
		"2l – Diese Interaktion wird nicht mehr protokolliert. (Haben Sie zu lange gewartet?)",
...
> - *Off*: Using proxy tags will proxy an alter, otherwise a normal message is sent.`,
	...
	DISPLAY_TAG_ENFORCE_DESC:
		'This user cannot proxy in this server without a system tag due to the system display tag enforcement policy. Enable display tags for your system by going into `pb;system config` -> "Public Profile".',
